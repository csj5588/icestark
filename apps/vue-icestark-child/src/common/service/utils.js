...
export const getRequestRoots = (root) => {
  const self = {
    ...
    getRoot2: getCurryUrl(root, config.REQ_TYPE.GET),

    getRoot3: getCurryUrl(root, config.REQ_TYPE.GET),
    ...
    postRoot2: getCurryUrl(root, config.REQ_TYPE.POST),
    postRoot3: getCurryUrl(root, config.REQ_TYPE.POST),
    /**
